...
<head>
    ...
    <title>Nithish S - Portfolio</title>
...
<body>
    ...
    <section id="about">
        <h2>About Me</h2>
        <img src="E:\Modern Exp\Nithish.png.jpg" alt="Nithish S" class="profile-pic">
    ...
    <section id="contact">
        <h2>Contact Me</h2>
        <p>Email: <a href="mailto:nithish81227@gmail.com">nithish81227@gmail.com</a></p>
        <p>Phone: <a href="tel:+918122747018">8122747018</a></p>
        <p><strong>GitHub:</strong> <a href="https://github.com/Nithish23013509" target="_blank">GitHub Profile</a></p>
        <p><strong>LinkedIn:</strong> <a href="https://www.linkedin.com/in/nithish-s-072038297/ target="_blank">LinkedIn Profile</a></p>
    </section>

    <footer>
        <p>&copy; 2025 Nithish S. All rights reserved.</p>
    </footer>
</body>
</html>
```
...
![Screenshot 2025-04-25 161953](https://github.com/user-attachments/assets/701c3c8a-6916-48e8-9c5f-1da946c67595)
![image](https://github.com/user-attachments/assets/3de30dcb-8a86-4a4c-ab50-6680fa874088)
![image](https://github.com/user-attachments/assets/5bd3be33-bff8-48f1-b7b4-4df2d3494c6b)
![image](https://github.com/user-attachments/assets/0812ebcb-b4a6-4a9d-b7b4-df2f5bae8083)
